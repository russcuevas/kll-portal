...
<body class="theme-red">
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                ...
                <div class="info-container">
                    <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Arjay Olgado</div>
    ...
    <script>
        // Define your custom document definition
            ...
            content: [{
                ...
                },
                {
                    table: {
                        headerRows: 1,
                        body: [
                            ['Student #', 'Student Name', 'Student Year', 'Student Course', 'Marks', 'Action'],
                            ['2021-029', 'Arjay Abad', 'III', 'Bachelor of Science in Computer Science', {
                                text: 'Enrolled',
                                color: 'green'
                            }, 'View Update Delete']
        ...
        // Generate PDF when the page is loaded
        document.addEventListener("DOMContentLoaded", function() {
            var pdfButton = document.createElement("button");
            pdfButton.innerText = "Generate PDF";
            pdfButton.onclick = function() {
                pdfMake.createPdf(documentDefinition).download('student_information.pdf');
            };
